        ...
        <Box p={5} bg={"#EDF2F7"} flex={4} m={4} w={"100%"}>
          ...
          <VStack spacing={4}>
            <Flex
              ...
              alignItems={"center"}
            >
              <Text textColor={"gray.600"} fontSize={18}>
                Subtotal
              </Text>
              <Text textColor={"gray.800"} fontSize={20}>
                $670
              </Text>
            </Flex>
            <Flex
          ...
          <Flex
            ...
            w={"100%"}
          >
            <Text textColor={"gray.900"} fontSize={18}>
              Order Total
            </Text>
            <Text fontWeight={"medium"} textColor={"black"} fontSize={20}>
              $670
            </Text>
          </Flex>
          <Divider my={8} />
