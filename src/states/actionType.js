...
export const CartActionType = {
  ...
  UPDATE_PRODUCT_TO_CART_REQUEST: "UPDATE_PRODUCT_TO_CART_REQUEST",
  UPDATE_PRODUCT_TO_CART_SUCCESS: "UPDATE_PRODUCT_TO_CART_SUCCESS",
  UPDATE_PRODUCT_TO_CART_FAILURE: "UPDATE_PRODUCT_TO_CART_FAILURE",
